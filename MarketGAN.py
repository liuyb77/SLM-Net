...
class MarketGAN(object):
    ...
    def init(self, args):
        ...
        ##############################################
        ## Runtime directory
        code_dir = os.path.abspath("C:\\Users\\yb666\\Desktop\\Market-GAN-main")
        ...
        # Output directories
        args.model_path = os.path.abspath(f"C:\\Users\\yb666\\Desktop\\Market-GAN-main")
        out_dir = os.path.abspath(args.model_path)
        if not os.path.exists(out_dir):
            os.makedirs(out_dir, exist_ok=True)

        f = open(f"C:\\Users\\yb666\\Desktop\\Market-GAN-main\\output/{args.exp}/res.log", 'a')
        backup = sys.stdout
